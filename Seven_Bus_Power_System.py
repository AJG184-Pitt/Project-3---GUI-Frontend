...
print(f"\nSolution Faults Current: {faults.calculate_fault_currents(circuit1.buses["Bus4"])[0]}")
print(f"\nSolution Faults Bus Voltages: {faults.calculate_fault_currents(circuit1.buses["Bus4"])[1]}")
